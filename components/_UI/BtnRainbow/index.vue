  ...
  <component
    ...
    :class="
      cn(
        ...
        `bg-[linear-gradient(${props.backgroundColor},${props.backgroundColor}),linear-gradient(#121213_50%,rgba(18,18,19,0.6)_80%,rgba(18,18,19,0)),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))]`,
